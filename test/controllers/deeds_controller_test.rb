...
class DeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deed" do
    assert_difference('Deed.count') do
      post deeds_url, params: { deed: { content: @deed.content, image_url: @deed.image_url, title: @deed.title, user_giver_id: @deed.user_giver_id, user_receiver_id: @deed.user_receiver_id } }, as: :json
    end
